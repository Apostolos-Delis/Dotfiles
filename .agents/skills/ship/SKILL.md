---
name: ship
description: "End-to-end ship workflow. Merge main, run tests, run a pre-landing review, create bisectable commits, push the branch, and open a PR for a ready feature branch."
---

# Ship: End-to-End Ship Workflow

You are running the ship workflow. This is a **non-interactive, fully automated** workflow. Do NOT ask for confirmation at any step unless specified. The user invoked `$ship` — do it.
...
- **The goal is: user invokes `$ship`, next thing they see is the PR URL.**
